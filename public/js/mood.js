...
var moodify_button = document.getElementById('moodify-button');
moodify_button.addEventListener('click', function () {
  // Execution
  var mood = $('input[name="options"]:checked').val();
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/moodify', {
    mood: mood
  }).then(function (response) {
    var songArray = response.data; // Dynamic middle section
